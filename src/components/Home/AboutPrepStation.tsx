        ...
        <div className="items-center lg:flex">
          <div className="lg:w-1/2">
            ...
            <p className="mt-4 text-sm text-gray-500 dark:text-gray-400 lg:max-w-md">
              ...
              to MBA aspirants for Indian Business Schools and helps in easy
              facilitation of their respective queries that arise during the
              preparation of competitive examinations. We, at PrepStation act
              like a friend to the candidates, who are knowledgeable and
              reliable. We plan to give them an idea of where they stand among
              thousands of applicants, and where they need to reach. Since we
              understand an aspirant's thought process, it makes it more
              reliable and relatable for the users and helps them get the
              required guidance.
            </p>
