    ...
    <div className="flex flex-col items-center py-8">
      <div className="w-full max-w-md p-8 space-y-3 border rounded-xl">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-1 text-sm">
            <label htmlFor="password" className="block text-coolGray-600">
              Password
            </label>
            <input
              type="password"
          ...
          <button className="w-full tw-primary-btn">Sign in</button>
        </div>
        ...
        <p className="text-xs text-center sm:px-6 text-coolGray-600">
          Don't have an account?
          <a href="#" className="underline text-coolGray-800">
            Sign up
          </a>
        </p>
      </div>
